...
- **Q:** Would you like to switch to a high-capability Codex model at high reasoning effort for this module?
    - **R:** Yes (set a high-capability Codex model at high effort).
...
- **Q:** Would you like to switch to the model control for this module?
    - **R:** Yes (step down from a high-capability Codex model; effort stayed at high).
- **Q:** Are you done modifying the model and effort?
    - **R:** Yes.
