...
```bash
python3 "<plugin-root>/scripts/package_bootcamp.py" --profile share --dry-run
python3 "<plugin-root>/scripts/package_bootcamp.py" --profile transfer --dry-run
```
...
```bash
python3 "<plugin-root>/scripts/package_bootcamp.py" --profile <share|transfer>
```
